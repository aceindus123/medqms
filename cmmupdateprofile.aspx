<%@ Page Title="" Language="C#" MasterPageFile="cmmheader.master" AutoEventWireup="true" CodeFile="cmmupdateprofile.aspx.cs" Inherits="cmmupdateprofile" %>
...
<asp:Label ID="qaid" runat ="server" Text="Edit Profile"  ></asp:Label>
</td>
   ...
   <tr><td width="80%" align="center">
    ...
    <br /><br /><br />
      <asp:Label ID="capa" runat="server" CssClass="homebodyheadings" Text="Edit Profile"></asp:Label>
      <br />
