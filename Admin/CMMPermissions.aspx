<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CMMPermissions.aspx.cs" Inherits="Admin_CMMPermissions" %>
...
<head  runat="server">
    <title>:: CMM Permission Page ::</title>
           ...
           <br />
                ...
                <table width="100%" >
                            <tr><td align="center" id="View" runat="server">
                                <font size="5" color="#00277a"><strong>Permissions List</strong></font>
                              </td>
                            </tr>
                            </table>
          </div>
