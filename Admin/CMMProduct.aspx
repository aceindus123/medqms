<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CMMProduct.aspx.cs" Inherits="Admin_CMMProduct" %>
           ...
           <br />
                ...
                <table width="100%" >
                            <tr><td align="center" id="View" runat="server">
                                <font size="5" color="#00277a"><strong>Product List</strong></font>
                              </td>
                            </tr>
                            </table>
          </div>
