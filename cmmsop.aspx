<%@ Page Title="" Language="C#" MasterPageFile="cmmheader.master" AutoEventWireup="true" CodeFile="cmmsop.aspx.cs" Inherits="cmmsop" %>
...
<asp:Label ID="qaid" runat ="server" Text="SOP"  ></asp:Label>
</td>
   ...
   <tr><td width="80%" align="center">
    ...
    <br /><br /><br />
      <asp:Label ID="capa" runat="server" CssClass="homebodyheadings" Text="SOP"></asp:Label>
      <br />
