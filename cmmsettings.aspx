<%@ Page Title="" Language="C#" MasterPageFile="cmmheader.master" AutoEventWireup="true" CodeFile="cmmsettings.aspx.cs" Inherits="cmmsettings" %>
...
<asp:Label ID="qaid" runat ="server" Text="Settings"></asp:Label>
</td>
   ...
   <tr><td width="80%" align="center">
    ...
    <br /><br /><br />
      <asp:Label ID="capa" runat="server" CssClass="homebodyheadings" Text="Settings"></asp:Label>
      <br />
