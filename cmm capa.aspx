<%@ Page Title="" Language="C#" MasterPageFile="cmmheader.master" AutoEventWireup="true" CodeFile="cmm capa.aspx.cs" Inherits="cmm_capa" %>
...
<asp:Label ID="qaid" runat ="server" Text="CAPA"  ></asp:Label>
</td>
   ...
   <tr><td width="80%" align="center">
    ...
    <br /><br /><br />
      <asp:Label ID="capa" runat="server" CssClass="homebodyheadings" Text="CAPA"></asp:Label>
      <br />
