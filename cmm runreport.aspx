<%@ Page Title="" Language="C#" MasterPageFile="cmmheader.master" AutoEventWireup="true" CodeFile="cmm runreport.aspx.cs" Inherits="cmm_runreport" %>
...
<table id="table2" border="0" style="border:1px solid #7496c2" width="100%"> 
                 ...
                 <asp:Button ID="btnAudit" Text="Show Run Report" runat="server" 
